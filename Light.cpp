...
//functie de schimbare a intensitatii luminii
void Light::SetDiffuseLight(Vector4D _diff)
{
	diffuse=_diff;
}
...
//functie care seteaza directia luminii
void Light::SetLightDirection(Vector3D _dir)
{
	direction=_dir;
}
